...
public class BlockRegistry
{
   ...
   {
      // I use multiple sections here to sort things. It's just my system, you don't have to. Just delete "registerBlockSet2"
      // and "registerAllBlocks" then make this public. Make sure to change the call in the main class.
