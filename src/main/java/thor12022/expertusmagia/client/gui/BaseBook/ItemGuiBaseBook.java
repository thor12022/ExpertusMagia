...
public class ItemGuiBaseBook extends GuiScreen
{
   ...
   {
      fontRendererObj.drawString(TextHelper.localize("gui." + ModInformation.ID + ".basebook.title.main"),
            bookXStart + 60, 20, 0x000000);
   ...
   {
      fontRendererObj.drawString(TextHelper.localize("gui." + ModInformation.ID + ".basebook.title.1"),
            bookXStart + 70, 20, 0x000000);
   ...
   {
      fontRendererObj.drawString(TextHelper.localize("gui." + ModInformation.ID + ".basebook.title.3"),
            bookXStart + 70, 20, 0x000000);
   ...
   {
      fontRendererObj.drawString(TextHelper.localize("gui." + ModInformation.ID + ".basebook.title.4"),
            bookXStart + 70, 20, 0x000000);
